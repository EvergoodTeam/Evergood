...
recipes.addShaped(<rftools:crafter1>, [[<enderio:item_alloy_ingot:9>, <enderio:item_basic_capacitor>, <enderio:item_alloy_ingot:9>],[<thermalfoundation:material:352>, <rftools:machine_frame>, <thermalfoundation:material:352>], [<enderio:item_alloy_ingot:3>, <minecraft:crafting_table>, <enderio:item_alloy_ingot:3>]]);
