...
recipes.addShaped(<fluxnetworks:fluxpoint>, [[<fluxnetworks:flux>, <fluxnetworks:fluxcore>, <fluxnetworks:flux>],[<fluxnetworks:fluxcore>, <redstonearsenal:storage:1>, <fluxnetworks:fluxcore>], [<fluxnetworks:flux>, <fluxnetworks:fluxcore>, <fluxnetworks:flux>]]);
